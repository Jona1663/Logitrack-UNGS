...
public class DataSeed implements CommandLineRunner {
        ...
        protected void cargarDatosSemilla() {
                try {
                        ...
                        //ADMINISTRADORES
                        Usuario adm1 = usuarioRepository.saveAndFlush(Usuario.builder().username("admin1@logitrack.com")
                                        .passwordHash(defaultPass).rol(RolUsuario.ADMINISTRADOR).activo(true).build());
                        personaRepository.saveAndFlush(Persona.builder().cuil("20-10000001-1").nombre("Carlos")
                                        .apellido("Admin").telefono("1122334455").idUsuario(adm1).build());

                        Usuario adm2 = usuarioRepository.saveAndFlush(Usuario.builder().username("admin2@logitrack.com")
                                        .passwordHash(defaultPass).rol(RolUsuario.ADMINISTRADOR).activo(true).build());
                        personaRepository.saveAndFlush(Persona.builder().cuil("20-10000002-2").nombre("Lucia")
                                        .apellido("Jefa").telefono("1122334456").idUsuario(adm2).build());

                        //OPERADORES 
                        Usuario op1 = usuarioRepository.saveAndFlush(
                                        Usuario.builder().username("operador1@logitrack.com").passwordHash(defaultPass)
                                                        .rol(RolUsuario.OPERADOR).activo(true).build());
                        personaRepository.saveAndFlush(Persona.builder().cuil("20-20000001-1").nombre("Marcos")
                                        .apellido("Operario").telefono("1133445566").idUsuario(op1).build());

                        Usuario op2 = usuarioRepository.saveAndFlush(
                                        Usuario.builder().username("operador2@logitrack.com").passwordHash(defaultPass)
                                                        .rol(RolUsuario.OPERADOR).activo(true).build());
                        personaRepository.saveAndFlush(Persona.builder().cuil("20-20000002-2").nombre("Ana")
                                        .apellido("Recepcion").telefono("1133445567").idUsuario(op2).build());


                        //SUPERVISORES
                        Usuario sup1 = usuarioRepository.saveAndFlush(Usuario.builder()
                                        .username("supervisor1@logitrack.com").passwordHash(defaultPass)
                                        .rol(RolUsuario.SUPERVISOR).activo(true).build());
                        personaRepository.saveAndFlush(Persona.builder().cuil("20-30000001-1").nombre("Roberto")
                                        .apellido("Control").telefono("1144556677").idUsuario(sup1).build());

                        Usuario sup2 = usuarioRepository.saveAndFlush(Usuario.builder()
                                        .username("supervisor2@logitrack.com").passwordHash(defaultPass)
                                        .rol(RolUsuario.SUPERVISOR).activo(true).build());
                        personaRepository.saveAndFlush(Persona.builder().cuil("20-30000002-2").nombre("Elena")
                                        .apellido("Supervisora").telefono("1144556678").idUsuario(sup2).build());
                        ...
                        EmpresaCliente emp1 = empresaClienteRepository.saveAndFlush(EmpresaCliente.builder()
                                        ...
                                        .tipoEmpresa(TipoEmpresa.PRODUCTOR).rucaNro("R-1001").vtoRuca(futuro)
                                        .email("contacto@laspampas.com.ar").build());
                        ...
                        EmpresaCliente emp2 = empresaClienteRepository.saveAndFlush(EmpresaCliente.builder()
                                        ...
                                        .tipoEmpresa(TipoEmpresa.ACOPIO).rucaNro("R-2002").vtoRuca(futuro)
                                        .email("logistica@acopioscentro.com.ar").build());
                        ...
                        EmpresaCliente emp3 = empresaClienteRepository.saveAndFlush(EmpresaCliente.builder()
                                        ...
                                        .tipoEmpresa(TipoEmpresa.PUERTO).rucaNro("R-3003").vtoRuca(futuro)
                                        .email("operaciones@tprosario.com.ar").build());
                        ...
                        EmpresaCliente emp4 = empresaClienteRepository.saveAndFlush(EmpresaCliente.builder()
                                        ...
                                        .tipoEmpresa(TipoEmpresa.MOLINO).rucaNro("RUCA-999").vtoRuca(pasado)
                                        .email("admin@molinofantasma.com.ar").build());

                        //ESTABLECIMIENTOS (5 por cada empresa = 20 en total) ---
                        List<Establecimiento> establecimientos = new ArrayList<>();

                        //Establecimientos Empresa 1 (Productor - Prov. Bs As y La Pampa)
                        establecimientos.add(crearEstablecimiento("Estancia El Sol",
                                        "Ruta 8 Km 120, San Antonio de Areco", -34.2500, -59.4667, emp1));
                        establecimientos.add(crearEstablecimiento("Campo La Esperanza", "Camino Vecinal S/N, Pergamino",
                                        -34.1833, -60.5833, emp1));
                        establecimientos.add(crearEstablecimiento("Lote Los Ombúes", "Ruta 5 Km 250, 9 de Julio",
                                        -33.8167, -60.8833, emp1));
                        establecimientos.add(crearEstablecimiento("Chacra San José", "Ruta 33 Km 320, Trenque Lauquen",
                                        -35.9667, -62.7333, emp1));
                        establecimientos.add(crearEstablecimiento("Estancia Sur", "Ruta 5 Km 600, Santa Rosa", -36.6167,
                                        -64.2833, emp1));

                        // Establecimientos Empresa 2 (Acopio - Sur de Santa Fe y Córdoba)
                        establecimientos.add(crearEstablecimiento("Planta Silos Venado Tuerto",
                                        "Ruta 8 y Ruta 33, Venado Tuerto", -33.7500, -61.9667, emp2));
                        establecimientos.add(crearEstablecimiento("Acopio Rufino", "Ruta 33 Km 535, Rufino", -34.2667,
                                        -62.7167, emp2));
                        establecimientos.add(crearEstablecimiento("Planta Casilda", "Ruta 33 Km 740, Casilda", -33.0333,
                                        -61.1667, emp2));
                        establecimientos.add(crearEstablecimiento("Silos Rio Cuarto", "Ruta 8 Km 600, Río Cuarto",
                                        -33.1333, -64.3500, emp2));
                        establecimientos.add(crearEstablecimiento("Acopio Marcos Juárez",
                                        "Ruta 9 Km 430, Marcos Juárez", -32.7000, -62.1000, emp2));

                        // Establecimientos Empresa 3 (Puertos - Zona Gran Rosario, Bahía Blanca,
                        // Quequén)
                        establecimientos.add(crearEstablecimiento("Terminal San Lorenzo", "Ruta 11 Km 330, San Lorenzo",
                                        -32.7333, -60.7333, emp3));
                        establecimientos.add(crearEstablecimiento("Puerto Gral. San Martín",
                                        "Av. San Martín S/N, Puerto Gral. San Martín", -32.7167, -60.7333, emp3));
                        establecimientos.add(crearEstablecimiento("Terminal Timbúes", "Ruta 11 Km 345, Timbúes",
                                        -32.6833, -60.7500, emp3));
                        establecimientos.add(crearEstablecimiento("Puerto Ing. White", "Zona Portuaria, Bahía Blanca",
                                        -38.7833, -62.2667, emp3));
                        establecimientos.add(crearEstablecimiento("Puerto Quequén", "Av. 10 y Calle 59, Necochea",
                                        -38.5667, -58.7000, emp3));

                        // Establecimientos Empresa 4 (Molinos - Dispersos / Casos Trampa)
                        establecimientos.add(crearEstablecimiento("Molino Norte", "Ruta 9 Km 200, Ramallo", -33.4833,
                                        -60.0000, emp4));
                        establecimientos.add(crearEstablecimiento("Planta Harinera Centro", "Parque Industrial, Pilar",
                                        -33.4500, -59.9000, emp4));
                        establecimientos.add(crearEstablecimiento("Molino Sur", "Ruta 3 Km 150, Las Flores", -36.0167,
                                        -59.1000, emp4));
                        establecimientos.add(crearEstablecimiento("Depósito 999", "Dirección Inexistente 999, CABA",
                                        -34.6037, -58.3816, emp4)); // CASO TRAMPA
                        establecimientos.add(crearEstablecimiento("Molino Viejo", "Ruta 188 Km 100, Rojas", -33.9500,
                                        -60.7333, emp4));

                        LocalDateTime hoyExacto = LocalDateTime.now();

                        for (int i = 1; i <= 50; i++) {
                                // Asignaciones seguras: Usamos los primeros 8 choferes y camiones (sanos y
                                // habilitados)
                                ChoferDetalle choferAsignado = choferes.get(i % 8);
                                Camion camionAsignado = camiones.get(i % 8);

                                // Origen y destino cruzados para que nunca sean el mismo establecimiento
                                ...
                                // Fechas dinámicas esparcidas en los últimos 2 meses
                                ...
                                // Casuística de los viajes
                                if (i <= 5) {
                                        // CANCELADOS (Los primeros 5 del loop)
                                        ...
                                        fechaLlegadaReal = fechaEta.plusHours(2 + (i % 5)); // Llegó entre 2 y 6 horas
                                                                                            // tarde
                                        ...
                                        estado = EstadoEnvio.ENTREGADO;
                                        fechaLlegadaReal = fechaEta.minusMinutes(30 + (i * 2)); // Llegó media hora o
                                                                                                // más antes del ETA
                                ...
                                Envio env = Envio.builder()
                                                .idEnvio("LT-HIST-" + String.format("%04d", i)) // ID forzado para
                                                                                                // identificar los
                                                                                                // históricos
                                                .cpe("CPE-H-" + 8000 + i)
                                ...
                                // Agregamos el historial simulando el cierre del viaje
                                historialEstadosRepository.saveAndFlush(HistorialEstados.builder()
                                                ...
                                                .estadoAnterior((estado == EstadoEnvio.CANCELADO)
                                                                ? EstadoEnvio.PENDIENTE
                                                                : EstadoEnvio.EN_REPARTO)
                                                .estadoNuevo(estado)
                                                .fechaHora(fechaLlegadaReal != null ? fechaLlegadaReal
                                                                : fechaCreacion.plusDays(1))
                                                .build());
                        }

  
                        // HISTORIAL DE EVALUACIONES (Tarea #614 - Para la DEMO)
                        ...
                        for (int i = 0; i < 12; i++) {
                                // Usamos el operador módulo (%) para rotar entre los choferes y envíos
                                // disponibles
        ...
        private Establecimiento crearEstablecimiento(String nombre, String direccion, Double lat, Double lon,
