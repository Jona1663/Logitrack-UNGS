...
public class MockController {
    ...
    // SIMULADOR CNRT - Validación de Licencia LiNTI ,si la licencia contiene '999',
    // el chofer está inhabilitado.
    ...
    public ResponseEntity<Map<String, Object>> validarCnrt(@PathVariable String nroLicencia) {
        ...
        // si la licencia esta vencida pero el nro de licencia ds valido actualiza el
        // vencimientos a un apño desde ñla fecha de chequeo
    ...
    // SIMULADOR RUCA - Validación de Registro de Empresas Agroalimentarias, si el
    // registro contiene 999, la empresa está suspendida.
    ...
    // Mock SENASA validacion de camiones si la patente tiene un 999 el camion esta
    // inhabilitado
